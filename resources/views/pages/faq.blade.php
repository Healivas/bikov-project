...
<head>
    ...
    <title> FAQ | FUNCASH.RU - Веселая прибыль!</title>
        ...
        <div class="inner">
            ...
            <nav class="nav">
                ...
                <ul>
                    ...
                    <li><a href="{{url('/faq')}}" class="eas active">FAQ</a></li>
        ...
        <div class="inner">
            ...
            <div class="static">
                ...
                <div class="b3 b3-2">
                    ...
                    Система Opcash основана на билетном алгоритме, который определяет число с учетом коэффицента и
                    случайной
                    генерации числа.
                </div>
                <div class="b3 b3-3">
                ...
                <div class="faq">
                    ...
                    Баланс на нашем сайте вы можете пополнить абсолютно разными способами: WebMoney, Яндекс.Деньги,
                    Приват24,
                    ЕвроСеть и т.п<br> Чтобы пополнить баланс, перейдите в свой личный кабинет и нажмите "Пополнить
                    баланс"
                </div>
                <div class="faq">
                ...
                <div class="faq">
                    ...
                    Программа для вычисления победителя основана на генерации случайного числа исходя из процентного
                    шанса
                    приза. Чем дороже приз - тем меньше шанс выпадения.
                </div>
                <div class="faq">
                    <div class="question">Что такое партнерский код?</div>
                    Партнерский код - это код, благодаря которому Вы сможете <a href="#"
                                                                                title="Нажмите, чтобы продолжить, Not set">
                        дополнительно зарабатывать<img src="../../cdncache-a.akamaihd.net/items/it/img/arrow-10x10.png"
                                                       alt=""></a>
                ...
                <div class="faq">
                    ...
                    Вводить партнерский код нужно в своем личном кабинете. За это вы получаете бонус в размере 10
                    рублей.
                </div>
                <div class="faq">
                    <div class="question">Что такое увеличитель шанса?</div>
                    Увеличитель шанса, дает вам шанс выиграть более дорогой приз чаще чем обычно. Чем выше ваш
                    дополнительный
                ...
                <div class="faq">
                    ...
                    Вывод средств производится в течении 24-х часов. Если, вдруг, средства не пришли в течении
                    указанного
                    времени - обратитесь в тех.поддержку.
                </div>
                <div class="touch-now text-center">
                    <h3>Не нашли ответ на ваш вопрос?</h3>
                    <a class="btn yellow rounded" href="support/index.html">Задать вопрос</a></div>
            </div>
            <div class="cls"></div>
