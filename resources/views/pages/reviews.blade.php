...
<head>
    ...
    <title> Отзывы о сайте | FUNCASH.RU - Веселая прибыль!</title>
    ...
    <meta name="description" content=" Отзывы о сайте "/>
    <meta name="keywords" content=" Отзывы о сайте "/>
        ...
        <div class="inner">
            ...
            <nav class="nav">
                ...
                <ul>
                    ...
                    <li><a href="{{url('/reviews')}}" class="eas active">Отзывы</a></li>
                </ul>
            </nav>
            <div class="cls"></div>
        </div>
    ...
    <main class="content">
        <div class="inner">
            ...
            <div class="static text-center">
                ...
                <script type="text/javascript" src="../../vk.com/js/api/openapi7f1d.js?135"></script>
        ...
        <div class="inner">
            <div class="l">
                <ul>
                    ...
                    <li><a href="{{url('/faq')}}" class="eas">FAQ</a></li>
                    <li><a href="{{url('/guarantees')}}" class="eas">Гарантии</a></li>
                    <li><a href="{{url('/reviews')}}reviews.html" class="eas active">Отзывы</a></li>
