...
<head>
    ...
    <title> Конкурс | FUNCASH.RU - Веселая прибыль!</title>
...
<div class="wrapper">
        ...
        <div class="inner">
            ...
            <nav class="nav">
                ...
                <ul>
                    ...
                    <li><a href="{{url('/content')}}" class="eas active"><span class="flaticon-gift"></span> Конкурс
                            "Ютюбер"</a>
                    </li>
    ...
    <main class="content">
        <div class="inner">
            ...
            <div class="gifts"><h1>Конкурс "Ютюбер"!</h1>
                <h2 style="
    font-size: 50px;
    margin-bottom: 37px;
    color: #f2c924;
">Приз: 5000 Рублей!</h2>
                ...
                <div class="info-1 gift-case">
                    ...
                    <div class="textyoutube"
                         style="margin-left: 225px;padding-left: 9px;font-size: 24px;margin-top: 30px;">
                ...
                <div class="info-2 gift-case">
                    <h3>Требования</h3><img src="../templates/site/dist/img/daily-ooo.png" align="left">
                    <div class="textyoutube">
                        1) Снять качественное видео<br>2) Показать достоинства сайта<br>3) Добавить ссылку в
                        описание<br> 4) Отписать в <a href="support/index.html">поддержку</a> сайта<br>5) Ждать
                        результатов
                    </div>
                </div>
                <div class="cls"></div>
                <h3 style="
">После одобрения вашего видео, оно попадет в этот список.</h3>
                <h3>Учавствующие видео:</h3>
                <div class="daily-winner">
                    <div class="daily-winner-in">
                        <iframe width="440" height="190" src="https://www.youtube.com/embed/rlMdANyYGCI" frameborder="0"
