...
<!-- Mirrored from funcash.ru/case/1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Nov 2016 07:38:07 GMT -->
<!-- Added by HTTrack -->
...
<head>
    ...
    <title> Кейс "{{$case->name}}" | FUNCASH.RU - Веселая прибыль!</title>
    ...
    <meta name="description" content=" Кейс " Бедняга
    " "/>
    <meta name="keywords" content=" Кейс " Бедняга
    " "/>
                    ...
                    <div class="t1">
                        <div class="img">
                            <a href="{{url('profile/'.$user->id)}}">
                                <img src="https://pp.vk.me/c636725/v636725899/306a9/wDNTSOGk61o.jpg"
                                     alt="Sarchev Kirill">
                                <img src="{{$user->photo}}" alt="cover" class="back eas">
                            </a>
                        </div>
                        <div class="u-cases"><span class="flaticon-case"></span> {{$user->cases->count()}}</div>
                        <div class="u-money"><span class="flaticon-money"></span>{{$user->balance}}.00<span
...
<!-- Mirrored from funcash.ru/case/1 by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 02 Nov 2016 07:38:29 GMT -->
</html>
