    ...
    <div class="row">
        <div class="col-sm-6 col-md-6 col-md-offset-3 col-sm-offset-3">
            <form class="form-horizontal" method="POST">
                <fieldset>
                    <div id="legend">
                        <legend class="">Создание кейсса</legend>
                    </div>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" id="price" name="price" placeholder="" class="input-xlarge"> руб.
                        </div>
                    </div>
                    <div class="control-group">
                    ...
                    <div class="control-group">
                        <div class="controls">
                            <button class="btn btn-success">Создать кейс</button>
                        </div>
                    </div>
                </fieldset>
            </form>
